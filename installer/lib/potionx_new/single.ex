defmodule Potionx.New.Single do
  ...
  template :potionx, [
    ...
    {:eex, "potionx/frontend/admin/src/useAdminHeaderAccount.ts", :app, "frontend/admin/src/useAdminHeaderAccount"},
    {:eex, "potionx/frontend/admin/src/useAdminHeaderNav.ts", :app, "frontend/admin/src/useAdminHeaderNav"},
