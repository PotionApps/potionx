...
export default defineComponent({
  ...
  setup (props: PaginationProps) {
    ...
    return () => {
      return (
        <div class="bg-white border-t-1 border-gray-300 bottom-0 flex items-center justify-center mt-4 shadow-negative s750:mt-8 pb-2 pt-2 sticky z-3">
          <div
            class={
          ...
          <span class={"font-bold text-gray-700 text-sm s450:text-base"}>
            ...
            {
              props.count && typeof props.countBefore == 'number' && props.limit &&
